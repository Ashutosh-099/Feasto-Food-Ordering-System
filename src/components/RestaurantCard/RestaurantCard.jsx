...
const RestaurantCard = (props) => {
    ...
    return (
        <div className="grid gap-1 rounded-xl transition duration-150 ease-in-out transform hover:-translate-y-1 hover:scale-90">
            <img src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + imageURL} alt="restaurant--image" className="h-48 w-full rounded-xl object-cover z-10" />
            <div className="px-2">
